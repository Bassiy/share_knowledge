...
同じ「行・列」でも、設計レベルによって呼び方が変わる。

| 用語セット | 行 | 列 | 使用文脈 |
|---|---|---|---|
| タプル / アトリビュート | タプル | アトリビュート | 論理設計・リレーショナル理論 |
| ロー / カラム | ロー | カラム | 物理設計・DBMS寄り |
| レコード / フィールド | レコード | フィールド | 実装フェーズ・アプリ側 |
...
## タグ
DB設計, 概念設計, 論理設計, 物理設計, ER図, 正規化, DBMS, 3層スキーマ, トレードオフ, エンティティ, 用語
