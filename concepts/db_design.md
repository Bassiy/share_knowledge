...
| ハードウェアのサイジング | 必要なCPU・メモリ・ストレージの規模を見積もる → `hardware_sizing` 参照 |
...
- hardware_sizing（物理設計の5タスクのひとつ。サイジングの詳細はこちら）
...
## タグ
DB設計, 概念設計, 論理設計, 物理設計, ER図, 正規化, DBMS, 3層スキーマ, トレードオフ, エンティティ, インデックス
